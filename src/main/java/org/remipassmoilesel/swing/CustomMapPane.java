 ...
 * <p>
 * A lightweight map pane which uses a single cachedpanel and backing image.
...
public class CustomMapPane extends AbstractMapPane {
     ...
     * @param renderer the cachedpanel to use for drawing layers
     */
    ...
    public void setMapContent(MapContent content) {
        ...
        if (content != null && renderer != null) {
            ...
            // then the map content will already have been set with the cachedpanel
            //
    ...
    /**
     * Gets the cachedpanel, creating a default one if required.
     *
     * @return the cachedpanel
     */
    ...
    /**
     * Sets the cachedpanel to be used by this map pane.
     *
     * @param renderer the cachedpanel to use
     */
