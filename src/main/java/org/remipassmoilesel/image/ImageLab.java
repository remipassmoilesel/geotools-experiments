 ...
 * - countries.shp
 *
 * In the earlier examples we looked at reading and displaying shapefiles. For ImageLab.java we are going to add
...
public class ImageLab {
     ...
     * method
     * <p>
     * One thing that has been a mystery until now is how the DataStore wizards are created.
     * The wizards are created from a description of the parameters needed when connecting. We are going to
     * use these same facilities now to prompt the user:
     * <p>
     ...
     *
     * To display the map on screen we create a MapContent, add the image and the shapefile to it, and pass it to a JMapFrame. Rather than
     * using the static JMapFrame.showMap method, as we have in previous examples, we create a map frame and customize it by
     * adding a menu to choose the image display mode.
     *
     * @param rasterFile
     *            the GeoTIFF file
     * @param shpFile
